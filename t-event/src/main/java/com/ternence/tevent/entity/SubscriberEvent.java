package com.ternence.tevent.entity;
 ...
 *
 * his class only verifies the suitability of the method and event type if something fails.  Callers are expected to
...
public class SubscriberEvent extends Event
{
    ...
    private void initObservable() {
        ...
        subject.onBackpressureLatest().observeOn(EventThread.getScheduler(thread))
