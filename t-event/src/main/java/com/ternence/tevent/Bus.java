...
import com.ternence.tevent.entity.DeadEvent;
import com.ternence.tevent.entity.EventType;
import com.ternence.tevent.entity.ProducerEvent;
import com.ternence.tevent.entity.SubscriberEvent;
import com.ternence.tevent.finder.Finder;
...
public class Bus {
    ...
    /**
     * indicates whether an object has registered,return true when call register AND the class of Object params HAS method with annotation @Subscribe.false otherwise .
     * @param object target
    ...
    public boolean isRegistered(Object object){
        ...
        for (EventType type : foundSubscribersMap.keySet()) {
            ...
            if (subscribers!=null){
                final Set<SubscriberEvent> foundSubscribers = foundSubscribersMap.get(type);
                return subscribers.containsAll(foundSubscribers);
            }
        }
        return false;
    }
